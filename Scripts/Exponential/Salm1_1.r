...
data<-read.csv("Salm1_1.csv",header = TRUE,sep=";")
...
Salm222<-filter(data,str_detect(code1,"r222")&t<14)
Salm222<-data.frame(t=Salm222$t,LOG10N=log10((10^Salm222$log10N/34047.63)))
fitSalm222 <- nls(baranyi_without_lag, Salm222,
                list(  mumax=0.8, LOG10N0 = 2.3, LOG10Nmax = 5.6))
pSalm222<-coef(fitSalm222)
overview(fitSalm222)

plotfit(fitSalm222, col.fit="blue",smooth = TRUE,ylab="log10(biovolume)",xlab = "time (h)",xlim=c(0,14),ylim=c(-1.3,1.3))+title("Salm1-r222")
## 
