...
data<-read.csv("Salm1_2.csv",header = TRUE,sep=";")
...
Salm111<-filter(data,str_detect(code1,"r111")&t<17)
...
# r211 = donn?es manquantes dans cette s?rie
...
Salm221<-filter(data,str_detect(code1,"r221")&t<17)
...
# # r222 = donn?es manquantes dans cette s?rie
...
#           list(  mumax=0.8, LOG10N0 = 2.3, LOG10Nmax = 5.6))
# pSalm222<-coef(fitSalm222)overview(fitSalm222)
